...
global2local(const PatchParams &p, const svec_t &global_coords)
 ...
 */
CCTK_HOST CCTK_DEVICE CAPYRX_EXTERNAL auto
local2global(const PatchParams &p, int patch, const svec_t &local_coords)
    -> svec_t;
 ...
 */
CCTK_HOST CCTK_DEVICE CAPYRX_EXTERNAL auto
dlocal_dglobal(const PatchParams &p, int patch, const svec_t &local_coords)
 ...
 */
CCTK_HOST CCTK_DEVICE CAPYRX_EXTERNAL auto
d2local_dglobal2(const PatchParams &p, int patch, const svec_t &local_coords)
