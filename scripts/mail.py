...
text = "HTML only email, please see https://einsteintoolkit.github.io/capyrx-tests for output"

curr_ver = get_version()
summary=f"./records/version_{curr_ver}/build__2_1_{curr_ver}.log"
baseurl = "https://github.com/einsteintoolkit/capyrx-tests"
...
msg['Subject'] = f"CapyrX test report: {status}"
msg['From'] = "jenkins@build-test.barrywardell.net"
msg['To'] = "capyrx-developers@einsteintoolkit.org"
